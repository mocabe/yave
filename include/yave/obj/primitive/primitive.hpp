...
namespace yave {
  ...
  using Float32 = Box<float>;
  using Float64 = Box<double>;
  ...
  using Float32Ptr = Box<float *>;
  using Float64Ptr = Box<double *>;

  using BoolPtr  = Box<bool *>;
  using IntPtr   = Int64Ptr;
  using FloatPtr = Float64Ptr;
...
YAVE_DECL_TYPE(yave::Float32, "2c907962-4976-4649-ab2f-4a755e17e52d");
YAVE_DECL_TYPE(yave::Float64, "fa73b107-dd48-4a96-831d-e28b34afb9b8");
...
YAVE_DECL_TYPE(yave::Float32Ptr, "aeb878d2-9742-4553-ac67-85fac62e09b7");
YAVE_DECL_TYPE(yave::Float64Ptr, "4ed6ada2-dd81-4eb9-b7e8-0b30bbd5d38a");

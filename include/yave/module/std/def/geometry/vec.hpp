...
#include <yave/module/std/decl/geometry/vec.hpp>
...
namespace yave {
  ...
  template <>
  struct node_definition_traits<node::Vec2, modules::_std::tag>
  {
  ...
  template <>
  struct node_definition_traits<node::Vec3, modules::_std::tag>
  {
    static auto get_node_definitions() -> std::vector<node_definition>
    {
  ...
  template <>
  struct node_definition_traits<node::Vec4, modules::_std::tag>
  {
    static auto get_node_definitions() -> std::vector<node_definition>
    {

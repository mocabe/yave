...
//    };
//
//    wm::window_manager wm(glfw_ctx);
//
//    auto vp = wm.add_viewport(100, 100, u8"test");
//    REQUIRE(vp);
//
//    REQUIRE(!wm.add_window({}, 0, std::make_unique<win>()));
//
//    REQUIRE(wm.add_window(vp->id(), 0, std::make_unique<win>()));
